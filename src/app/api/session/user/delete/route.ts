...
// Note - because of fact that signOut will WORK AS EXPECTED only if
// function that contains it called by the browser requests (not by XHR or fetch)
// there are only 2 ways how custom functions maybe implemented in a amnner that will allow
